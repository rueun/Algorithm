...
public class P1712 {
	public static void main(String[] args) throws IOException {
		...
		int A = Integer.parseInt(st.nextToken()); // 년 고정 지출
		int B = Integer.parseInt(st.nextToken()); // 노트북 한 대 만드는 비용
	...
	private static int Bep(int a, int b, int c) {
		if(b >= c) {
			return -1;
		}
		
		int netSales = c - b; // 순 이익
